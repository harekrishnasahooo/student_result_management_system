...
class result_Class:
    def __init__(self, root):
        ...
        lbl_full_marks = Label(self.root, text="Marks Obtained", font=("goudy old style", 15, 'bold'), bg='white').place(x=50, y=340)
    ...
    def add(self):
        ...
        try:
            if self.var_name.get()=="":
                messagebox.showerror("Error","pls first seach student record ",parent=self.root)
            else:
